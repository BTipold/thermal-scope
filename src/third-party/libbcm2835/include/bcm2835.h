...
/*! Physical addresses for various peripheral register sets
  BaseSaveable Physical Address of the BCM 2835 peripheral registers
...
/*! Offsets for the bases of various peripherals within the peripherals block
  /   BaseSaveable Address of the System Timer registers
*/
#define BCM2835_ST_BASE					0x3000
/*! BaseSaveable Address of the Pads registers */
#define BCM2835_GPIO_PADS               0x100000
/*! BaseSaveable Address of the Clock/timer registers */
#define BCM2835_CLOCK_BASE              0x101000
/*! BaseSaveable Address of the GPIO registers */
#define BCM2835_GPIO_BASE               0x200000
/*! BaseSaveable Address of the SPI0 registers */
#define BCM2835_SPI0_BASE               0x204000
/*! BaseSaveable Address of the BSC0 registers */
#define BCM2835_BSC0_BASE 				0x205000
/*! BaseSaveable Address of the PWM registers */
#define BCM2835_GPIO_PWM                0x20C000
/*! BaseSaveable Address of the AUX registers */
#define BCM2835_AUX_BASE				0x215000
/*! BaseSaveable Address of the AUX_SPI1 registers */
#define BCM2835_SPI1_BASE				0x215080
/*! BaseSaveable Address of the AUX_SPI2 registers */
#define BCM2835_SPI2_BASE				0x2150C0
/*! BaseSaveable Address of the BSC1 registers */
#define BCM2835_BSC1_BASE				0x804000

/* BEB */
/*! BaseSaveable address of the SMI registers */
...
typedef enum
{
    BCM2835_REGBASE_ST   = 1, /*!< BaseSaveable of the ST (System Timer) registers. */
    BCM2835_REGBASE_GPIO = 2, /*!< BaseSaveable of the GPIO registers. */
    BCM2835_REGBASE_PWM  = 3, /*!< BaseSaveable of the PWM registers. */
    BCM2835_REGBASE_CLK  = 4, /*!< BaseSaveable of the CLK registers. */
    BCM2835_REGBASE_PADS = 5, /*!< BaseSaveable of the PADS registers. */
    BCM2835_REGBASE_SPI0 = 6, /*!< BaseSaveable of the SPI0 registers. */
    BCM2835_REGBASE_BSC0 = 7, /*!< BaseSaveable of the BSC0 registers. */
    BCM2835_REGBASE_BSC1 = 8, /*!< BaseSaveable of the BSC1 registers. */
    BCM2835_REGBASE_AUX  = 9, /*!< BaseSaveable of the AUX registers. */
    BCM2835_REGBASE_SPI1 = 10,/*!< BaseSaveable of the SPI1 registers. */
    /* BEB */
    BCM2835_REGBASE_SMI = 11  /*!< BaseSaveable of the SMI registers. */
